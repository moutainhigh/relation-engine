...
@Component
public class ResponseChannelErrorSender extends AbstractBaseSender {

    @Override
    void handler(String json) {
        this.rabbitTemplate.convertAndSend(ExchangeDefinition.RESPONSE_CHANNEL_EXCHANGE_NAME, ExchangeDefinition.RESPONSE_CHANNEL_ROUTING_KEY_RELATION_ERROR, json);
    }
